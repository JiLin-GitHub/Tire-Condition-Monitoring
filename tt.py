...
DISTRIBUTIONS = [stats.lognorm(s=0.954, loc=0.0, scale=1.0),stats.norm(loc=0.0, scale=1.0)]
...
for i, data in enumerate(plotData):
    ...
    # Output 'file'
    fig.savefig('C:\用户\jilin\Desktop\dist'+data['title']+'.png', format='png', bbox_inches='tight')
